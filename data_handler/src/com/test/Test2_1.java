...
public static void main(String[] args) {
		...
		try { 
            ...
            BufferedReader reader1 = new BufferedReader(new FileReader("F:/station.txt"));//换成你的文件名
            ...
            File csv = new File("F:/station_20181227_3.txt"); // CSV数据文件			    
            ...
            while((line=reader.readLine())!=null&&((line1=reader1.readLine())!=null)){ 
                ...
                bw.write(onerow1[0]+","+a12+","+a21+","+a31+","+a41+","+a51+","+a61+","+a71+","+a81);
                bw.newLine();
            } 
            bw.close();
        } catch (Exception e) { 
